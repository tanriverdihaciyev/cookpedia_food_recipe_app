...
class MostSearchesView extends StatelessWidget {
  const MostSearchesView({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: const Text("Most Searches"),
          actions: [
        ...
        body: Padding(
          ...
          child: const MSBodyWidget(),
        ));
  }
}

class MSBodyWidget extends StatelessWidget {
  const MSBodyWidget({
    super.key,
  });
